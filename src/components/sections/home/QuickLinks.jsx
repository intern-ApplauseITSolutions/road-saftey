    ...
    <section className="py-12 sm:py-16 md:py-20 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center text-brand-black mb-8 sm:mb-10 md:mb-12">
            Explore Our Work
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            ...
            <Link to="/focus" className="bg-gradient-green text-white rounded-xl p-6 sm:p-8 shadow-lg hover:shadow-2xl transition transform hover:-translate-y-2">
              <Shield className="w-10 h-10 sm:w-12 sm:h-12 mb-3 sm:mb-4" />
            ...
            <Link to="/events" className="bg-gradient-orange text-white rounded-xl p-6 sm:p-8 shadow-lg hover:shadow-2xl transition transform hover:-translate-y-2">
              <Shield className="w-10 h-10 sm:w-12 sm:h-12 mb-3 sm:mb-4" />
            ...
            <Link to="/contact" className="bg-teal-blue text-white rounded-xl p-6 sm:p-8 shadow-lg hover:shadow-2xl transition transform hover:-translate-y-2">
              <Shield className="w-10 h-10 sm:w-12 sm:h-12 mb-3 sm:mb-4" />
